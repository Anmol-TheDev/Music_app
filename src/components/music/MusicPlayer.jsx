...
/**
 * Renders a bottom drawer music player with artwork-driven background, playback controls, seek and volume controls, and keyboard shortcuts.
 *
 * The component reads playback state and control functions from stores, synchronizes the current song and queue, extracts dominant colors from album art for the background, and mounts a hidden ReactPlayer instance for audio playback.
 *
 * @returns {JSX.Element|null} A React element that displays the drawer-based music player when a current song exists, otherwise `null`.
 */
